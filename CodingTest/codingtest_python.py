...
# 순열 : 서로다른 n개 중에 m개를 선택하는 경우의 수 (순서 o, 중복 x) : n!/(n-r)!, 재귀함수
def DFS(v):
    global cnt
    if v == m :
        print(res)
...
#(정점1, 정점2, 가중치)
# 만약 1->2 비용과 2->1 비용이 다르다면 (정점2, 정점1, 가중치) 도 리스트에 넣어줘야함 
lst = [(1,2,8), (1,3,6), (1,5,5), (2,3,-5), (2,4,1) ,(2,6,4) ,(3,4,4) ,(4,7,3),(5,6,5),(6,2,0),(6,7,-7)] 
...
for v in lst:
    ...
    dist[v[1]][v[0]] = v[2]  # 인접한 노드로 가는 비용 (1->2 비용과 2->1 비용이 다르면 이 줄은 실행 x)
