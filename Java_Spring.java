...
// 행위패턴 (반복적으로 사용되는 객체들의 상호작용을 패턴화)
    ...
    // Strategy : 유사한 행위들을 캡슐화하여, 객체의 행위를 바꾸고 싶은 경우 직접 변경하는 것이 아닌 전략만 변경하여, 유연하게 확장하는 패턴
    // Visitor
...
// jpa auditing : Entity에서 데이터타입이 localDatetime인 컬럼에 자동으로 시간 넣어주는 기능 https://webcoding-start.tistory.com/53
